...
export default function ManageAccessDialog({ user, open, setOpen }: Props) {
    ...
    const [updateRoles, { isLoading: rolesLoading }] = useUpdateUserRolesMutation();
    const [updatePermissions, { isLoading: permissionsLoading }] =
        useUpdateUserPermissionsMutation();
    ...
    async function handleSave() {
        try {
            await updateRoles({ id: user.id, roles: selectedRoles }).unwrap();
